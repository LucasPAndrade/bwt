...
describe("PATCH /api/v1/users/[username]", () => {
  describe("Anonymous user", () => {
    ...
    test("With duplicated 'email'", async () => {
      ...
      const response = await fetch(
        `http://localhost:3000/api/v1/users/${createdUser2.username_normalized}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
    ...
    test("With unique 'username'", async () => {
      ...
      expect(responseBody).toEqual({
        ...
        email_normalized: createdUser.email_normalized,
    ...
    test("With unique 'email'", async () => {
      ...
      const response = await fetch(
        `http://localhost:3000/api/v1/users/${createdUser.username_normalized}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
      ...
      expect(responseBody).toEqual({
        ...
        username_normalized: createdUser.username_normalized,
        email: "uniqueEmail2@mail.com",
    ...
    test("With new 'password'", async () => {
      ...
      const userInDatabase = await user.findOneByUsername(
        createdUser.username_normalized,
      );
